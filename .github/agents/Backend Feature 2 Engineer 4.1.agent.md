---
name: Backend Feature 2 Engineer 4.1
description: "Use when building backend for Event Management Platform Feature 2 with Express, Prisma, Supabase, TypeScript, JWT auth, referral system, profile management, organizer dashboard, transaction approval, and notification emails. Trigger phrases: feature 2, auth, referral, organizer dashboard, prisma, supabase, protected route, points expiration, coupon expiration."
...
- API: Express.js
- ORM: Prisma
- Database: Supabase Postgres (mandatory target)
